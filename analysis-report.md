...
For this study, I will develop and evaluate three prediction models - Elastic Net Logistic Regression, XGBoost, and LSTM - to determine the effect that semantic content has on skip prediction accuracy. I will examine the features that best predict skip patterns, as well as how the order of tracks affects this. Below are the results.

To access the Tableau Dashboard, which visualizes these results [click here](https://public.tableau.com/app/profile/christian.uriostegui/viz/Instacart_Dashboard21/ExecutiveSummary2). 
...
| Feature | Positive Values Mean | Negative Values Mean |
|:-------:|:--------------------:|:--------------------:|
| Popularity | More popular than average | Less popular than average |
...
- Genre inconsistency is a strong skip predictor.
